...
import { AboutIcon, AnVatIcon, CartIcon, HomeIcon, HotIcon, LoveIcon, ManageIcon } from './../component/Icon/Icon';
...
export const adminNavigation = [
    ...
    // {path: "/buipholove", icon: LoveIcon,name: "Bụi Phố Love",component: BuiPhoLove},
    // {path: "/cart", icon: CartIcon,name: "Giỏ hàng",component: Cart, cart:true},
    {path: "/managa", icon: ManageIcon,name: "Quản lý",component: Manage},
]
